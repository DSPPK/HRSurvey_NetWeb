<%@ Page Title="" Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeBehind="Question20.aspx.cs" Inherits="DXWebApplication1.Question20" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <div class="jumbotron">
        <div class="container">
            <h1>Pilihan Tujuan Mutasi ke-2 (SECONDARY)</h1>
