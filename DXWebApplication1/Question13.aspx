<%@ Page Title="" Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeBehind="Question13.aspx.cs" Inherits="DXWebApplication1.Question13" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <div class="jumbotron">
        <div class="container">
            ...
            <br />
            <dx:BootstrapMemo ID="memReasonsDontWantToMutation" runat="server" Rows="5" NullText="Harap diisi dengan lengkap dan detil." MaxLength="4000">
            ...
            <span class="chrm" style="font-size: smaller">Characters remaining:
                <dx:ASPxLabel ID="memReasonsDontWantToMutation_cr" runat="server" EnableClientSideAPI="True" />
            </span>
            <br />
            <br />
