<%@ Page Title="" Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeBehind="Question11.aspx.cs" Inherits="DXWebApplication1.Question11" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <div class="jumbotron">
        <div class="container">
            <h1>Tujuan Mutasi ke-1 (PRIMARY) : Kantor Pusat</h1>
